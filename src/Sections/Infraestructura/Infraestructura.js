            ...
            <Columna>
              ...
              >
                <ColumnImage varbackgroundimage="#FFFFFF">
                  <img
                    src={img1Infraestructura}
                    id="image"
                    alt="ciudad encantada-infraestructura edificio"
                  ></img>
                </ColumnImage>
                <ColumnImage varbackgroundimage="#FFFFFF">
                  <img
              ...
              <div className="beneficios">
                ...
                >
                  <Columna>
                    <img
                      src={camara}
                      id="icon"
                      alt="Sistema de video vigilancia"
                    />
                  </Columna>
                  <Columna>
                    <h4>Sistema de video vigilancia </h4>
                    <Roboto fontsize="18px">
                      Sistema de video vigilancia en todas las vialidades del
                      desarrollo. Para lograr ser una de las zonas más seguras
                ...
                >
                  ...
                  <Columna>
                    ...
                    <Roboto fontsize="18px">
                      Drenaje pluvial en todo el desarrollo para evitar los
                ...
                >
                  <Columna>
                    <img
                      src={oficina}
                      id="icon"
                      alt="Oficina de administracion central"
                    />
                  </Columna>
                  <Columna>
                    <h4>Oficina de administración central </h4>
                    <Roboto fontsize="18px">
                      Administración general de las cuotas de mantenimiento del
                      desarrollo para asegurar el excelente mantenimiento del
                      desarrollo.
                    </Roboto>
                  </Columna>
                </Columnas>
                ...
                >
                  ...
                  <Columna>
                    ...
                    <Roboto fontsize="18px">
                      Planta de tratamiento para asegurar el agua requerida para
                      las áreas verdes de manera auto-sustentable.
                    </Roboto>
                  </Columna>
                </Columnas>
              </div>

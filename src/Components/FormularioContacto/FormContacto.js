        ...
        <div className="popup-content-items">
          ...
          >
            <Columna>
              ...
              >
                <Columna>
                <svg className='conexiones' width="82%" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg width="82%" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Columna  className='conexiones' >
                <svg width="82%" height="52" viewBox="0 0 53 52" fill="none" xmlns="http://www.w3.org/2000/svg">
